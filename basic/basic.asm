...
CR      .EQU    0AH             ; Carriage return OLD 0DH
...
MSIZE:  
        ;LD      HL, $FFFF
        ;JP      SETTOP          ; Set top of memory, skips RAM test
...
BFREE:  .BYTE   " Bytes free",CR,0,0

SIGNON: .BYTE   "Z80 BASIC Ver 4.7b",CR
        .BYTE   "Copyright ",40,"C",41
        .BYTE   " 1978 by Microsoft",CR,0,0
...
TSTBRK: RST     18H             ; Check input status
        ...
        ;IN      A,($81)         ; MODIFIED: CHECK IF CORRECT
        ;OR      A
        ;RET     Z
...
REDO:   .BYTE   "?Redo from start",CR,0
...
CLS: 
        ...
        LD       HL, CLR_SCREEN ; ANSI Clear screen
        JP       PRS
